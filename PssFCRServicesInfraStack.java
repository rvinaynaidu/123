...
public class PssFCRServicesInfraStack extends Stack {
	...
	public PssFCRServicesInfraStack(final Construct parent, final String id, final StackProps props,CdkContext context) {
		...
		Role iamRole = software.amazon.awscdk.services.iam.Role.Builder.create(this, "IAM-Role")
							...
							.roleName("ecs-tet-role-pss-fcr-demo")
							.build();
...
//		}
		...
		software.amazon.awscdk.services.iam.Policy.Builder.create(this, "Task Role Policy")
		...
		System.out.println("Security Groups "+Objects.toString(securityGroups));
		createFargateService(serviceCluster,vpc,securityGroups,subnetSelection,context);


	}
	
	
	public void createFargateService(ICluster cluster, IVpc vpc, 
